      ...
      <Drawer>
        <DrawerTrigger asChild>
          ...
          <svg
            ...
            className="md:hidden flex lucide lucide-menu"
          >
        ...
        <DrawerContent>
          <div className="mx-auto w-full flex flex-col gap-2 p-4 items-center justify-center">
          <NavigationMenu className="">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              href="https://github.com/hemansai"
            >
