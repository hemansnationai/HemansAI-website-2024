  ...
  return (
    <div className="w-full flex md:hidden justify-between items-center">
      <a className="mr-6 flex items-center space-x-2" href="/">
        ...
        />
        <span className="inline-block font-bold md:hidden">HemansAI</span>
      </a>
      <Drawer>
        <DrawerTrigger asChild>
          {/* <Button variant="outline"> */}
            {/* <Image alt="HemansAI logo" src="/images/logo.png" height={48} width={48} className="ml-6 h-6 w-6" /> */}
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="md:hidden flex lucide lucide-menu"><line x1="4" x2="20" y1="12" y2="12"/><line x1="4" x2="20" y1="6" y2="6"/><line x1="4" x2="20" y1="18" y2="18"/></svg>
              {/* </Button> */}
            </DrawerTrigger>
            <DrawerContent>
